...
// Este token se puede leer desde la CLI si es necesario
const externalServiceToken =
  process.env.EXTERNAL_SERVICE_TOKEN || "aaabbbcccddd";
...
const config = {
  ...
  plugins: [
    ...
    new DefinePlugin({
      EXTERNAL_SERVICE_TOKEN: JSON.stringify(externalServiceToken),
    }),
  ],
