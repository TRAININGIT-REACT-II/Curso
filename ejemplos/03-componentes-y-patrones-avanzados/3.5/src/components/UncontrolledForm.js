  ...
  return <div className="row">
    <div className="col-6">
      <form onSubmit={onSubmit}>
        ...
        <input ref={nameRef} id="uncontrolled-name" type="text" defaultValue={formState.name} />
        <label htmlFor="uncontrolled-color">Color favorito</label>
        <input ref={colorRef} id="uncontrolled-color" type="color" defaultValue={formState.color} />
