  ...
  return (
    <Layout title="3.2 Error Boundaries">
      <section aria-labelledby="title" aria-describedby="desc">
        ...
        <p id="desc">
          Un <code>Error Boundary</code> es un componente de React que captura
          excepciones que ocurren en los nodos descendentes. Este podrá mostrar
          una interfaz alternativa en lugar de causar un error global en la
          aplicación.
        </p>
        <ErrorBoundary message="Algo ha salido mal!" onReset={onReset}>
          <Title {...holaProps}>Hola</Title>
          <ErrorBoundary
            message="Algo ha salido mal en Adios!"
            onReset={onReset}
          >
